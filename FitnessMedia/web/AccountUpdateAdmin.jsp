        ...
        <!-- Edit Modal HTML -->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="post" id="updateA" action="AdminUpdate">
                        <div class="modal-header" style="background-color: aqua">						
                            <h4 class="modal-title">Edit Account Detail</h4>
                            <button type="submit" class="close" name="btnX">&times;</button>
                        </div>
                        <div class="modal-body">					
                            <div class="form-group">
                                <label>ID:</label>
                                <input name="userId" value="${account.user_id}" type="text" class="form-control" readonly="">
                            </div>
                            <div class="form-group">
                                <label>Full Name:</label>
                                <input value="${user.imgWall}" type="text" class="form-control" readonly="">
                            </div>
                            <div class="form-group">
                                <label>Username:</label>
                                <input value="${account.user_name}" type="text" class="form-control" readonly="">
                            </div>
                            <div class="form-group">
                                <label>Email:</label>
                                <input value="${account.user_email}" type="text" class="form-control" readonly="">
                            </div>
                            <div class="form-group">
                                <label>Role:</label>
                                <select name="role" form="updateA">
                                    <c:forEach items="${role}" var="ro">
                                        <option value="${ro.roleId}" ${ro.roleName==account.role_name?"selected":""}>${ro.roleName}</option>
                                    </c:forEach>
                            ...
                            <div class="form-group">
                                <label>Status:</label>
                                <input type="radio" name="status" value="false" ${account.deleted==false?"checked":""}> <span style="color:green">Active</span>
                                
                                <input type="radio" name="status" value="true" ${account.deleted==true?"checked":""}> <span style="color:red">Inactive</span>
                            </div>					
                        </div>
                        <div class="modal-footer">
                            <input type="submit" name="btnCancel" class="btn btn-default" data-dismiss="modal" value="Cancel">
