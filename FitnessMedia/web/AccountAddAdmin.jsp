                ...
                <div class="modal-content">
                    <form method="post" action="AdminAdd">
                        <div style="background-color: aqua" class="modal-header">						
                            ...
                            <button name="btnX" type="submit" class="close" aria-hidden="true">&times;</button>
                        </div>
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                               ...
                               <p style="color:red"> ${mess1} ${mess4}</p> 
                            </div>
                            <div class="form-group">
                                <label>Phone:</label>
                                <input name="phone" type="text" class="form-control" required>
                               <p style="color:red"> ${MessPhone} ${MessPhone2}</p> 
                            </div>
                        ...
                        <div class="modal-footer">
                            <input name="btnCancel" type="submit" class="btn btn-default" value="Cancel">
                            <input name="btnAdd" type="submit" class="btn btn-success" value="Add">
                        </div>
                    </form>
                </div>
            </div>
