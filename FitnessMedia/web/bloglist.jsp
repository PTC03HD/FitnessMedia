                            ...
                            <div class="blog-pagination">
                                ...
                                <c:if test="${endPage!=0}">
                                    <c:if test="${index_save<=1}">
                                        <a class="frist" href="GymPostList?index=${index_save}">Prev</a>
                                    </c:if>
                                    <c:if test="${index_save>1}">        
                                        <a class="frist" href="GymPostList?index=${index_save-1}">Prev</a>
                                    </c:if>
                                </c:if>
                                <!--number-->
                                <c:if test="${endPage<=5}">
                                    <c:forEach begin="1" end="${endPage}" var="i">
                                        ...
                                        <a href="GymPostList?index=${i}">${i}</a>
                                ...
                                <c:if test="${endPage!=0}">
                                    <c:if test="${endPage<=index_save}">
                                        <a class="last" href="GymPostList?index=${endPage}">Next</a>
                                    </c:if>
                                    <c:if test="${endPage>index_save}">    
                                        <a class="last" href="GymPostList?index=${index_save+1}">Next</a>
                                    </c:if>
                                </c:if>
