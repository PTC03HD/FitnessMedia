                        ...
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            <form action="updateProfile" method="post">                             
                                <div class="col-md-8" style="margin-left:80px">
                                    <input value="${user.userId}" name="userid_edit" type="hidden">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label>Image</label>
                                        </div>
                                        <div class="col-md-4">
                                            <input value="${user.imgAvatar}" type="file" name="image" style="margin-bottom:50px;width:250px">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input value="${user.idCitizen}" type="text" name="idcitizen" style="margin-bottom:50px;width:250px" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <input value="${user.imgWall}" type="text" name="fullname" style="margin-bottom:50px;width:250px" required>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input value="${user.userEmail}" type="text" name="usermail" style="margin-bottom:50px;width:250px" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input value="${user.perPhone}" type="text" name="phone" style="margin-bottom:50px;width:250px" required>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="password" name="confirm" style="margin-bottom:50px;width:250px" required>
                                            
                                        </div>
                                    </div>
                                    <div class="profile-edit-btn" style="margin-left:265px;">
                                        <input type="submit" class="btn btn-success" name="btnEdit" value="Save"/>
                                        <input type="submit" class="btn btn-dark" name="btnCancel" value="Cancel"/>
                                    </div> 
                                </div>
                            </form>
