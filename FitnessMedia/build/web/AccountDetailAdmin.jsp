                ...
                <div class="modal-content">
                        ...
                        <div class="modal-header" style="background-color: aqua">						
                            ...
                            <form method="post" action='AdminDetail'>
                                <button name='btnX' type="submit" class="close">&times;</button>
                            </form>
                            
                        </div>
                        <div class="modal-body">					
                            <div class="form-group" style="margin-left:185px">
                                <img src="img/avatar-1.png" alt="alt" class="w-10 h-10 rounded-full" style="width:100px"/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input value="${user.userName}" type="text" class="form-control" readonly="">
                            </div>
                            <div class="form-group">
                                <label>Email:</label>
                                <input value="${user.userEmail}" type="text" class="form-control" readonly="">
                            </div>
                            <div class="form-group">
                                <label>Role:</label>
                                <input value="${account.role_name}" type="text" class="form-control" readonly="">
                            </div>					
                            <div class="form-group">
                                <label>Status:</label>
                                <h4 style="color:${user.deleted==false?"yellowgreen":"red"}">${user.deleted==false?"Active":"Inactive"}</h4>
                            </div>					
                        </div>
