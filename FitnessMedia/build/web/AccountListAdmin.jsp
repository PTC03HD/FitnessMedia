        ...
        <div class="container">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-4">
                            <h2 style="color:white">Account List</h2>
                        </div>
                        <div class="col-sm-4">
                            <div class="dropdown">
                                <button onclick="myFunction()" class="dropbtn" style="margin-left:100px">Find User</button>
                        ...
                        <div class="col-sm-4">
                            <a href="./AdminAdd" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Add New Account</span></a>			
                        </div>
                    </div>
                </div>
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <c:forEach items="${acc}" var="a">
                            <tr>
                                <td class="px-6 py-4 whitespace-nowrap">${a.user_id}</td>
                                <td class="px-6 py-4 whitespace-nowrap"><img src="img/avatar-1.png" alt="alt" class="w-10 h-10 rounded-full"/></td>
                                <td class="px-6 py-4 whitespace-nowrap"> 
                                    <a href="./AdminDetail?aid=${a.user_id}">${a.user_name}</a>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">${a.user_email}</td>
                                <td class="px-6 py-4 whitespace-nowrap">${a.role_name}</td>
                                <td class="px-6 py-4 whitespace-nowrap" style="color:${a.deleted==false?"yellowgreen":"red"}">${a.deleted==false?"Active":"Inactive"}</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <a href="./AdminUpdate?aid=${a.user_id}" class="edit"><i class="material-icons" title="Edit">&#xE254;</i></a>
                                    <a href="./AdminDelete?aid=${a.user_id}" class="delete"><i class="material-icons" title="Delete">&#xE872;</i></a>
                                </td>
                            </tr>
                ...
                <div class="clearfix">
                    <div class="hint-text">Showing <b>${size}</b> out of <b>${toa.total}</b> accounts</div>
                    <ul class="pagination">
