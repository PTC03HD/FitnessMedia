 ...
 * @author dodat
 */
public class FilterGymPost extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FilterGymPost</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet FilterGymPost at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        String gymid_raw=request.getParameter("id");
        int gymid=Integer.parseInt(gymid_raw);
        int row = 0;
        try {
            recentnewslist = gympostservice.getRecentNews();
            row = gympostservice.countGymPostByGym(gymid);
        } catch (Exception e) {
        }
        ...
        try {
            gympostlist=gympostservice.getGymPostByGym(pageSize, index, gymid);
        ...
        request.setAttribute("gymid",gymid_raw);
        ...
        request.getRequestDispatcher("/filterbloglist.jsp").forward(request, response);
    } 
