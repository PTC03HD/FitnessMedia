...
import com.gym.DAO.homePageDAO;
...
public class homePageController extends HttpServlet {
    ...
    throws ServletException, IOException {
        //get data from GymPost Service
        GymPostService gymPost = new GymPostService();
        //get data from home page DAO
        homePageDAO dao = new homePageDAO();
        // control data
        List<homeDetail> list = dao.getAllGym();
        homeDetail2 popOwner = dao.getPopOwner();
        try{
            List<GymPost> gym = gymPost.getNewP();
            request.setAttribute("post", gym);
        }catch(Exception e){
        ...
        request.setAttribute("pop", popOwner);
